...
class VEICULOS:
    def listar(self, codigo_situacao, inicio_paginacao, quantidade_por_pagina, data_inicio, data_fim):
        ...
        response = requests.request("POST", ENDPOINTVEICULOS, json=payload, headers=headers)
    ...
    def bloqueios(self, usuario, senha, codigo_situacao, inicio_paginacao, quantidade_por_pagina):
